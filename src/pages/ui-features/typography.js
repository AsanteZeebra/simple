      ...
      <div className="row">
                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <address>
                          <p className="font-weight-bold">Skydash inc.</p>
                          <p> 695 lsom Ave, </p>
                          <p> Suite 00 </p>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description"> Use className <code>.text-primary</code>, <code>.text-secondary</code> etc. for text in theme colors </p>
                    <div className="row">
                      <div className="col-md-6">
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description"> Use className<code>.font-weight-bold</code>
                    </p>
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-description"> Use className <code>.text-lowercase</code>
                    </p>
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-description"> Use className <code>.text-uppercase</code>
                    </p>
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description"> Use className <code>.text-muted</code>
                    </p>
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-description"> Use className <code>.text-capitalize</code>
                    </p>
              ...
              <div className="col-md-4 grid-margin grid-margin-md-0 stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description">Add className <code>.list-ticked</code> to <code>&lt;ul&gt;</code></p>
              ...
              <div className="col-md-4 grid-margin grid-margin-md-0 stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">List with icon</h4>
                    <p className="card-description">Add className <code>.list-arrow</code> to <code>&lt;ul&gt;</code></p>
              ...
              <div className="col-md-4 grid-margin grid-margin-md-0 stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">List with icon</h4>
                    <p className="card-description">Add className <code>.list-star</code> to <code>&lt;ul&gt;</code></p>

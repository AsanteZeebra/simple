          ...
          <div className="row">
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description"> Add classNamees like <code>.form-select-lg</code> and <code>.form-select-sm</code>. </p>
                    <div className="form-group">
                      <label for="exampleFormControlSelect1">Large select</label>
                      <select className="form-select form-select-lg" id="exampleFormControlSelect1">
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
                    ...
                    <div className="form-group">
                      ...
                      <select className="form-select" id="exampleFormControlSelect2">
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
                    ...
                    <div className="form-group">
                      ...
                      <select className="form-select form-select-sm" id="exampleFormControlSelect3">
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
                  ...
                  <div className="card-body">
                    ...
                    <div className="form-group">
                      <div className="input-group d-flex align-items-center">
                        <input type="text" className="form-control form-control-sm" placeholder="Recipient's username" aria-label="Recipient's username" />
                        <div className="input-group-append">
                          <button className="btn btn-sm btn-primary ms-2" type="button">Search</button>
                        </div>
                      </div>
                    </div>
                    <div className="form-group">
                      <div className="input-group d-flex align-items-center">
                        <div className="input-group-prepend">
                          <button className="btn btn-sm btn-outline-primary dropdown-toggle me-2" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                        ...
                        <input type="text" className="form-control form-control-sm" aria-label="Text input with dropdown button"/>
                      </div>
                    </div>
                    <div className="form-group">
                      <div className="input-group d-flex align-items-center">
                        <input type="text" className="form-control form-control-sm" placeholder="Find in facebook" aria-label="Recipient's username" />
                        <div className="input-group-append">
                          <button className="btn btn-sm btn-facebook ms-2" type="button">
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="card-description">Add className <code>.form-check-{}</code> for checkbox and radio controls in theme colors</p>
                    <form>
                      <div className="row">
                        <div className="col-md-6">
                          <div className="form-group">
                  ...
                  <div className="card-body">
                    ...
                    <form className="form-inline">
                      ...
                      <div className="input-group mb-2 mr-sm-2">
                        ...
                        <input type="text" className="form-control form-control-sm" id="inlineFormInputGroupUsername2" placeholder="Username" />
                      </div>
